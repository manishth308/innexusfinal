    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 flex flex-col justify-center">
        ...
        <h1 class="text-4xl sm:text-6xl lg:text-[56px] font-extrabold text-white leading-[1.1] tracking-tight mb-6">
          Ad Creative Design Services Built to <span class="text-purple-400">Perform, Not Just Look Good</span>
        </h1>
      ...
      <div class="lg:col-span-5 relative flex justify-center lg:justify-end items-center mt-8 lg:mt-0">
        <div class="relative w-full max-w-[520px] aspect-[4/3] lg:aspect-square">
          <img
            ...
            alt="Ad Creative Design - InTech Nexus"
        ...
        <div>
          ...
          <ul class="space-y-3 text-gray-300">
            <li class="flex items-start gap-3">
              ...
              <span>Ad creative is not performing, and it is unclear if the issue is design or targeting.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-purple-400 font-bold">•</span>
              <span>The same visuals are being reused across every platform and audience.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-purple-400 font-bold">•</span>
              <span>Ad creative is being made without a clear connection to the campaign strategy.</span>
            </li>
          </ul>
        </div>
      </div>
...
<section class="py-20 bg-[#0b0c10] border-t border-white/5" x-data="{ openCap: null }">
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="mb-12">
      ...
      <p class="text-gray-400 text-lg">We design ad creative built around what actually drives performance.</p>
    </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Ad creative sized and formatted for each platform</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Multiple variations built for testing</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Creative aligned with campaign strategy and goals</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Ongoing refreshes as campaigns evolve</span></li>
        </ul>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Performance focused ad design</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Paid social and display creative design</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>A/B test friendly creative variation design</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Campaign aligned visual strategy</span></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <section class="py-20 bg-[#0b0c10] border-t border-white/5">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12">
        ...
        <p class="text-gray-400 text-lg">The stack we work with on ad creative design.</p>
      </div>
    ...
    <div class="space-y-4">
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 1 ? null : 1" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>Do you test multiple versions of an ad?</span>
        ...
        <div x-show="openFaq === 1" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Yes. We typically design a few variations so the marketing team can test what performs best with your audience.
        </div>
      </div>
      ...
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 2 ? null : 2" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>Can you design for both Google and Meta ads?</span>
        ...
        <div x-show="openFaq === 2" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Yes. We design creative sized and formatted for the platforms your campaigns run on.
        </div>
      </div>
      ...
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        ...
        <div x-show="openFaq === 4" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Yes. We design creative sized and formatted for the platforms your campaigns run on, whether that is PPC / Google Ads or Meta Ads.
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
    <div class="bg-white/[0.03] border border-purple-500/40 p-10 md:p-16 shadow-[0_0_40px_rgba(168,85,247,0.2)] hover:shadow-[0_0_60px_rgba(168,85,247,0.35)] transition-all duration-300">
      <h2 class="text-3xl md:text-5xl font-extrabold text-white mb-6">
        Ready for ad creative built to convert?
      </h2>
