...
<div class="ux-page bg-white">
  ...
  <header class="ux-hero relative overflow-hidden text-white">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">Branding</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          Branding Services That Build a Business People <span style="color:var(--blue-bright);">Recognize and Trust</span>
        </h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The current brand looks outdated or changes from platform to platform.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>There is no real brand system, just a logo and guesswork everywhere else.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The brand does not match where the business is now.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We build full brand systems, not just single pieces
        </h2>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A complete brand identity system</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Brand strategy and positioning documentation</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Full visual identity, including logo, color, and type</span></li>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            ...
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Logo design</span></li>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        <div class="p-10 md:p-16 text-white h-full flex flex-col justify-center" style="background:var(--navy-deep);">
          ...
          <h2 class="text-3xl md:text-4xl font-bold mt-4 mb-6">A brand system built to be used across web, product, and marketing</h2>
          <p class="text-white/70 leading-relaxed max-w-md">
            Brand work here is built to be used. It gets used by our own Web Development and Digital Marketing teams, and by yours. Every identity comes with a system that works across web, product, and marketing.
          </p>
        </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'Do you handle full rebrands or just new logos?', 'a' => 'Both. From a simple logo refresh to a full brand strategy and identity system.'],
          ['q' => 'Will the new brand work on our website and marketing?', 'a' => 'Yes. Brand systems are built to work cleanly with our Web Development and Graphic & Creative Design work.'],
          ['q' => 'Do you handle both strategy and design, or just one?', 'a' => 'Both. Brand strategy and visual identity are handled together in our process, since one should inform the other. See Brand strategy and identity for more detail.'],
          ['q' => 'Will the new brand work across our website and marketing?', 'a' => 'Yes. Brand systems are built to extend cleanly into Web Development and Graphic & Creative Design work.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to build a brand people remember?</h2>
