...
<div class="ux-page bg-white">
  ...
  <header class="ux-hero relative overflow-hidden text-white">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <a href="{{ url('/services/branding') }}" class="hover:text-white transition-colors">Branding</a>
        <span class="text-white/30">/</span>
        <span class="text-white/70">Brand Strategy and Identity</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          Brand Strategy and Identity Services for a Business People <span style="color:var(--blue-bright);">Recognize and Trust</span>
        </h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The brand feels inconsistent or unclear across different channels.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>There is no real strategy behind the current visual identity.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The brand does not reflect where the business is now.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We build brand strategy and visual identity together, as one connected system
        </h2>
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @foreach ([
          ['t' => 'Brand Identity Design Covering Logo, Color, and Typography', 'd' => 'Brand identity design covering logo, color, and typography, tied together as a coherent visual system.'],
          ['t' => 'Brand Positioning Services to Clarify How You Are Different', 'd' => 'Brand positioning services to clarify how you are different, so the identity is grounded in a clear market position.'],
          ['t' => 'Visual Identity Design Built to Work Across Every Channel', 'd' => 'Visual identity design built to work across every channel, from digital to print, without losing consistency.'],
          ['t' => 'Branding Agency Support from Strategy Through to Guidelines', 'd' => 'Branding agency support from strategy through to guidelines, with a single team handling the full process.'],
          ['t' => 'Brand Development Services for Businesses at Any Stage', 'd' => 'Brand development services for businesses at any stage, from new startups to established companies rebranding.'],
        ] as $i => $offer)
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A documented brand strategy and positioning statement</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A full visual identity system, including logo and color</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Brand guidelines your team can apply consistently</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Messaging direction to support the visual identity</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Brand strategy and positioning</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Visual identity design</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Brand messaging and voice development</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Brand guideline documentation</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--navy-deep);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
        @foreach ([
          'A documented brand strategy and positioning statement',
          'A full visual identity system, including logo and color',
          'Brand guidelines your team can apply consistently',
          'Messaging direction to support the visual identity',
        ] as $outcome)
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        <div class="p-6 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <p class="text-sm font-medium" style="color:var(--navy-deep);">Adobe Illustrator · Adobe InDesign</p>
        </div>
        <div class="p-6 border" style="border-color:var(--line); background:var(--bg-soft);">
          <p class="font-mono text-xs uppercase tracking-wider mb-3" style="color:var(--blue-accent);">Strategy</p>
          <p class="text-sm font-medium" style="color:var(--navy-deep);">Brand Workshops · Competitor Audits</p>
        </div>
        <div class="p-6 border" style="border-color:var(--line); background:var(--bg-soft);">
          <p class="font-mono text-xs uppercase tracking-wider mb-3" style="color:var(--blue-accent);">Documentation</p>
          <p class="text-sm font-medium" style="color:var(--navy-deep);">Brand Guideline Templates</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-14 border-t overflow-hidden" style="border-color:var(--line); background:var(--bg-soft);">
    ...
    <div class="relative">
      <div class="marquee-track">
        @for ($rep = 0; $rep < 2; $rep++)
          @foreach ([
            'Adobe Illustrator', 'Adobe InDesign', 'Brand Workshops', 'Competitor Audits', 'Brand Guideline Templates',
          ] as $tag)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        ...
        <div class="h-full min-h-[320px]" style="background-image:url('https://images.unsplash.com/photo-1558655146-9f40138edfeb?q=80&w=1200&auto=format&fit=crop'); background-size:cover; background-position:center;"></div>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'Do you handle both strategy and design, or just one?', 'a' => 'Both. Brand strategy and visual identity are handled together in our process, since one should inform the other.'],
          ['q' => 'Will we receive brand guidelines we can share with our team?', 'a' => 'Yes. A brand guideline document is part of our standard deliverable, so your team and any future partners can apply the identity consistently.'],
          ['q' => 'Do you handle both strategy and design, or just one?', 'a' => 'Both. Brand strategy and visual identity are handled together in our process, since one should inform the other.'],
          ['q' => 'Will we receive brand guidelines we can share with our team?', 'a' => 'Yes. A brand guideline document is part of our standard deliverable, so your team and any future partners can apply the identity consistently.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to build a brand strategy that actually holds up?</h2>
