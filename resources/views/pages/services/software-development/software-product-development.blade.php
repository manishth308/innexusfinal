      ...
      <div class="lg:col-span-7 flex flex-col justify-center">
        <nav class="flex items-center gap-2 text-sm font-medium text-purple-400 mb-6" aria-label="Breadcrumb">
          ...
          <a href="{{ url('/software-development') }}" class="hover:text-purple-300 transition-colors">Software Development</a>
           <span class="text-gray-500">/</span>
          <span class="text-purple-400">Software Product Development</span>
        </nav>

        <h1 class="text-4xl sm:text-6xl lg:text-[56px] font-extrabold text-white leading-[1.1] tracking-tight mb-6">
          Software Product Development From <span class="text-purple-400">Early Idea to Market Ready Launch</span>
        </h1>
      ...
      <div class="lg:col-span-5 relative flex justify-center lg:justify-end items-center mt-8 lg:mt-0">
        <div class="relative w-full max-w-[520px] aspect-[4/3] lg:aspect-square">
          <img 
            ...
            alt="Software Product Development - InTech Nexus" 
...
<section class="py-20 bg-[#0b0c10] border-t border-white/5">
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="mb-12">
      ...
      <p class="text-gray-400 text-lg">We handle end to end product development, from planning through to launch and support.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="group p-8 bg-white/[0.03] border border-purple-500/30 hover:border-purple-400 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.1)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Software Product Development Company</h3>
          <p class="text-gray-400 leading-relaxed text-sm">Support from idea to launch, covering planning, design, engineering, and QA.</p>
        </div>
      </div>

      <div class="group p-8 bg-white/[0.03] border border-purple-500/30 hover:border-purple-400 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.1)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Digital Product Development</h3>
          <p class="text-gray-400 leading-relaxed text-sm">Digital product development across web, mobile, and cloud platforms.</p>
        </div>
      </div>

      <div class="group p-8 bg-white/[0.03] border border-purple-500/30 hover:border-purple-400 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.1)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Product Engineering Services</h3>
          <p class="text-gray-400 leading-relaxed text-sm">Scalable product architecture and engineering for long term growth.</p>
        </div>
      </div>

      <div class="group p-8 bg-white/[0.03] border border-purple-500/30 hover:border-purple-400 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.1)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Custom Product Development</h3>
          <p class="text-gray-400 leading-relaxed text-sm">Custom product development tailored to your specific market and users.</p>
        </div>
      </div>
      ...
      <div class="group p-8 bg-white/[0.03] border border-purple-500/30 hover:border-purple-400 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.1)] transition-all duration-300 flex flex-col justify-between min-h-[220px] md:col-span-2">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">End to End Product Development</h3>
          <p class="text-gray-400 leading-relaxed text-sm">Complete product development including design, engineering, QA, and launch support.</p>
        </div>
      </div>
    </div>
  </div>
