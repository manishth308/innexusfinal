    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 flex flex-col justify-center">
        ...
        <h1 class="text-4xl sm:text-6xl lg:text-[56px] font-extrabold text-white leading-[1.1] tracking-tight mb-6">
          Custom Software Development Built Around <span class="text-purple-400">Your Exact Process</span>
        </h1>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 flex flex-col justify-between">
        <div>
          ...
          <p class="text-gray-300 leading-relaxed text-base">
            Businesses that need software built from the ground up for a process no off the shelf tool handles well.
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <ul class="space-y-3 text-gray-300">
            <li class="flex items-start gap-3">
              ...
              <span>Generic tools force your team to work around missing features.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-purple-400 font-bold">•</span>
              <span>Off the shelf software does not match how your business actually runs.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-purple-400 font-bold">•</span>
              <span>You need a custom software solution that can grow as the business grows.</span>
            </li>
          </ul>
        </div>
      </div>
...
<section class="py-20 bg-[#0b0c10] border-t border-white/5">
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="mb-12">
      ...
      <p class="text-gray-400 text-lg">We plan, build, and support custom software from the ground up.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3">
            ...
            <span>A fully custom software platform built around your workflow</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
          ...
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Integrations with your existing tools and data sources</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Requirements gathering and process mapping</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Custom backend and database design</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Secure authentication and access control</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="max-w-3xl mb-16">
      ...
      <p class="text-gray-400 text-lg leading-relaxed">
        A structured, transparent approach to building software that fits your business.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 items-center">
      <div class="p-10 md:p-16 text-white flex flex-col justify-center">
        ...
        <p class="text-gray-300 leading-relaxed max-w-md">
          We work as a full software development agency, not just a coding shop. The same team that plans the software also designs the interface and supports it after launch, so nothing gets lost between departments.
        </p>
      </div>
    ...
    <div class="space-y-4">
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 1 ? null : 1" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>How is custom software development different from buying off the shelf software?</span>
        ...
        <div x-show="openFaq === 1" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Off the shelf software is built for a general audience. Custom software is built around your exact process, so your team does not have to adjust how they work to fit the tool.
        </div>
      </div>
      ...
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 2 ? null : 2" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>Can you build software for a large, complex organization?</span>
        ...
        <div x-show="openFaq === 2" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Yes. We handle both smaller custom builds and larger enterprise software development projects, scoped to the size of the organization.
        </div>
      </div>
      ...
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 3 ? null : 3" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>Do you build the software in phases, or all at once?</span>
        ...
        <div x-show="openFaq === 3" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Most projects are built in structured phases, so you can review progress and give feedback before the next stage begins.
        </div>
      </div>
      ...
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 4 ? null : 4" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>What happens if our requirements change partway through?</span>
        ...
        <div x-show="openFaq === 4" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          We plan with some flexibility built in, and we will walk through the impact of any change on timeline and scope before proceeding.
        </div>
      </div>
    </div>
  </div>
