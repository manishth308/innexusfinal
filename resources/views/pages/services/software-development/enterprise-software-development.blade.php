    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 flex flex-col justify-center">
        <nav class="flex items-center gap-2 text-sm font-medium text-purple-400 mb-6" aria-label="Breadcrumb">
          ...
          <a href="{{ url('/services/software-development') }}" class="hover:text-purple-300 transition-colors">Software Development</a>
          <span class="text-gray-500">/</span>
          <span class="text-purple-400">Enterprise Software Development</span>
        </nav>

        <h1 class="text-4xl sm:text-6xl lg:text-[56px] font-extrabold text-white leading-[1.1] tracking-tight mb-6">
          Enterprise Software Development Built Around <span class="text-purple-400">Your Business Scale</span>
        </h1>

        <p class="text-lg sm:text-xl text-gray-300 leading-relaxed max-w-2xl font-normal mb-4">
          Enterprise software development services built around the complexity and scale of your organization, not generic templates forced to fit.
        </p>
        <p class="text-base text-gray-400 leading-relaxed max-w-2xl font-normal mb-8">
          We handle everything from discovery through long-term support, so the software scales with your team and processes instead of capping your growth.
        </p>
      ...
      <div class="lg:col-span-5 relative flex justify-center lg:justify-end items-center mt-8 lg:mt-0">
        <div class="relative w-full max-w-[520px] aspect-[4/3] lg:aspect-square">
          <img
            ...
            alt="Enterprise Software Development - InTech Nexus"
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Enterprise Application Development</h3>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Legacy Modernization</h3>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Integration & API Strategy</h3>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Security & Compliance</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>A fully custom enterprise platform built around your workflows</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Technical documentation and system architecture plans</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>API integrations with your existing tools and data sources</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Post launch support and managed services</span>
          </li>
        </ul>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Enterprise discovery and architecture design</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Cloud-native and microservices development</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Security-first access control and compliance</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Scalable infrastructure and DevOps</span>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="max-w-3xl mb-16">
      ...
      <p class="text-gray-400 text-lg leading-relaxed">
        A structured, transparent approach to building enterprise software on time, on budget, and aligned with your strategic objectives.
      </p>
    </div>
    ...
    <div class="space-y-6">
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Enterprise Discovery</h3>
          <p class="text-gray-300">We conduct stakeholder interviews, workflow audits, and technical assessments to define scope, compliance requirements, and success metrics.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Architecture & Roadmap</h3>
          <p class="text-gray-300">We design scalable system architecture, select the right tech stack, and create a phased delivery roadmap with clear milestones.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Agile Development</h3>
          <p class="text-gray-300">We build in sprints with regular stakeholder demos, ensuring the product evolves based on real feedback and changing business needs.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Rigorous Testing & QA</h3>
          <p class="text-gray-300">Automated testing, penetration testing, and performance benchmarking ensure the platform is secure, stable, and ready for enterprise deployment.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Deployment & Managed Support</h3>
          <p class="text-gray-300">We deploy with zero-downtime strategies, provide team training, and offer ongoing managed support and optimization services.</p>
        </div>
      </div>
    </div>
  </div>
