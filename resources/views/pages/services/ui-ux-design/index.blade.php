  ...
  <header class="ux-hero relative overflow-hidden text-white">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">UI/UX Design</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          UI UX Design Services That Turn Good Ideas Into <span style="color:var(--blue-bright);">Products People Use</span>
        </h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>Users drop off during sign up or key steps.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The interface feels outdated or looks different from screen to screen.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>Design choices are being made without any user research.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We design and test product experiences, from research to the final screen
        </h2>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A complete user experience design, from research to final screens</span></li>
            ...
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Interactive prototypes ready for user testing</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Developer ready design files for handoff</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            ...
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Information architecture and wireframing</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Visual and interaction design</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Design systems for scaling products</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to design a product people actually enjoy using?</h2>
