...
<div class="ux-page bg-white">
  ...
  <header class="ux-hero relative overflow-hidden text-white">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">SaaS UI UX Design</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          SaaS UI UX Design That Stays Clear as <span style="color:var(--blue-bright);">Your Product Grows</span>
        </h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The product has grown more complex, but the interface has not kept up.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>New users find the dashboard confusing or overwhelming.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>Design decisions are being made feature by feature, without an overall system.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We design SaaS interfaces built to stay clear as the product grows
        </h2>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A scalable SaaS design system and component library</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Dashboard and data heavy interface design</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Onboarding flows for new users</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Efficient, dense views for power users</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>SaaS product design at scale</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Dashboard and data visualization design</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>B2B and B2C SaaS design experience</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Design system architecture</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'Can you redesign our dashboard without disrupting current users?', 'a' => 'Yes. We can plan a phased redesign that improves the interface without a jarring, all at once change for existing users.'],
          ['q' => 'Do you design for both new users and power users?', 'a' => 'Yes. We design onboarding for new users and efficient, dense views for power users, since SaaS products usually need both.'],
          ['q' => 'Can you redesign our dashboard without disrupting current users?', 'a' => 'Yes. We can plan a phased redesign that improves the interface without a jarring, all at once change for existing users.'],
          ['q' => 'Do you design for both new and experienced users?', 'a' => 'Yes. We design onboarding for new users and efficient, dense views for power users, since most SaaS products need both.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to design a SaaS interface built to scale?</h2>
