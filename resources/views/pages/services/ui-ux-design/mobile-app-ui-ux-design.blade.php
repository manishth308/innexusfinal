...
<div class="ux-page bg-white">
  ...
  <header class="ux-hero relative overflow-hidden text-white">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <a href="{{ url('/services/ui-ux-design') }}" class="hover:text-white transition-colors">UI/UX Design</a>
        <span class="text-white/30">/</span>
        <span class="text-white/70">Mobile App UI UX Design</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          Mobile App UI UX Design Built Around <span style="color:var(--blue-bright);">Small Screens and Short Attention Spans</span>
        </h1>
        <p class="text-lg text-white/70 leading-relaxed mb-4 max-w-2xl">
          Mobile app UI UX design services for businesses that want an app people find intuitive from the very first screen.
        </p>
        <p class="text-base text-white/60 leading-relaxed mb-10 max-w-2xl">
          As part of our wider UI/UX Design practice, we design mobile experiences specifically for how people use their phones, not scaled down from a desktop layout. That difference shows up most in onboarding, where the first few screens decide whether a new user sticks around.
        </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <p class="leading-relaxed text-base" style="color:var(--text-muted);">
            Businesses launching a new app, or improving one that users find confusing.
          </p>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>New users drop off during onboarding or the first few screens.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The app interface feels cluttered or inconsistent from screen to screen.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>Design decisions were made without testing them with real users.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We design mobile app experiences based on how people actually use their phones
        </h2>
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @foreach ([
          ['t' => 'App UI UX Design for iOS and Android', 'd' => 'App UI UX design for iOS and Android, with interfaces tailored to each platform\'s expectations and patterns.'],
          ['t' => 'Mobile App Design Agency Experience Across Categories', 'd' => 'Mobile app design agency experience across categories, with designs adapted to different user needs and behaviors.'],
          ['t' => 'User Experience Design for Apps, Including Onboarding Flows', 'd' => 'User experience design for apps, including onboarding flows that reduce early drop off and improve retention.'],
          ['t' => 'App Interface Design with Reusable Component Libraries', 'd' => 'App interface design with reusable component libraries that keep the experience consistent as the app grows.'],
          ['t' => 'Mobile Product Design Tested with Real Users', 'd' => 'Mobile product design tested with real users, so decisions are based on behavior rather than assumptions.'],
        ] as $i => $offer)
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A full mobile app design, from research to final screens</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Onboarding flows designed to reduce early drop off</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A reusable component library for iOS and Android</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Developer ready files for handoff</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Mobile first interaction design</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Onboarding and retention focused UX</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>iOS and Android design pattern expertise</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Usability testing for mobile apps</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--navy-deep);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
        @foreach ([
          'A full mobile app design, from research to final screens',
          'Onboarding flows designed to reduce early drop off',
          'A reusable component library for iOS and Android',
          'Developer ready files for handoff',
        ] as $outcome)
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        <div class="p-6 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <p class="text-sm font-medium" style="color:var(--navy-deep);">Figma · Adobe XD · Sketch</p>
        </div>
        <div class="p-6 border" style="border-color:var(--line); background:var(--bg-soft);">
          <p class="font-mono text-xs uppercase tracking-wider mb-3" style="color:var(--blue-accent);">Prototyping</p>
          <p class="text-sm font-medium" style="color:var(--navy-deep);">Figma · Principle</p>
        </div>
        <div class="p-6 border" style="border-color:var(--line); background:var(--bg-soft);">
          <p class="font-mono text-xs uppercase tracking-wider mb-3" style="color:var(--blue-accent);">User Research</p>
          <p class="text-sm font-medium" style="color:var(--navy-deep);">Maze · UserTesting</p>
        </div>
        <div class="p-6 border" style="border-color:var(--line); background:var(--bg-soft);">
          <p class="font-mono text-xs uppercase tracking-wider mb-3" style="color:var(--blue-accent);">Developer Handoff</p>
          <p class="text-sm font-medium" style="color:var(--navy-deep);">Figma Dev Mode · Zeplin</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="py-14 border-t overflow-hidden" style="border-color:var(--line); background:var(--bg-soft);">
    ...
    <div class="relative">
      <div class="marquee-track">
        @for ($rep = 0; $rep < 2; $rep++)
          @foreach ([
            'Figma', 'Adobe XD', 'Sketch', 'Principle', 'Maze', 'UserTesting', 'Figma Dev Mode', 'Zeplin',
          ] as $tag)
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        <div class="p-10 md:p-16 text-white h-full flex flex-col justify-center" style="background:var(--navy-deep);">
          ...
          <h2 class="text-3xl md:text-4xl font-bold mt-4 mb-6">Planned for thumbs, small screens, and short attention spans</h2>
          <p class="text-white/70 leading-relaxed max-w-md">
            Mobile design here is planned around thumbs, small screens, and short attention spans, not scaled down from a desktop layout. That is what makes the difference between an app people understand instantly and one they abandon.
          </p>
        </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'Can you improve just our onboarding flow?', 'a' => 'Yes. A focused redesign of onboarding or another specific flow is common, and can meaningfully improve retention on its own.'],
          ['q' => 'Do you design for both iOS and Android?', 'a' => 'Yes. We design with both platforms in mind, respecting each one\'s own design patterns where it matters.'],
          ['q' => 'Can you improve just our onboarding flow?', 'a' => 'Yes. A focused redesign of onboarding or another specific flow is common and can meaningfully improve retention on its own.'],
          ['q' => 'Do you design differently for iOS and Android?', 'a' => 'We respect each platform\'s own design patterns where it matters, while keeping the overall experience consistent.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready for an app design people understand instantly?</h2>
