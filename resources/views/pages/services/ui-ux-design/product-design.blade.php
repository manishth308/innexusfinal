@extends('layouts.app')
@section('title', 'Product Design Services - InTech Nexus')
...
<div class="ux-page bg-white">
  ...
  <header class="ux-hero relative overflow-hidden text-white">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">Product Design</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          Product Design Services That Turn an Early Idea Into a <span style="color:var(--blue-bright);">Coherent Product</span>
        </h1>
        <p class="text-lg text-white/70 leading-relaxed mb-4 max-w-2xl">
          Product design services for teams that need to turn an idea into a coherent, usable digital product.
        </p>
        <p class="text-base text-white/60 leading-relaxed mb-10 max-w-2xl">
          As part of our wider UI/UX Design practice, we treat product design as a strategic step, not just visuals applied at the end. Getting the product strategy and design right early saves significant rework once development starts, which matters most for teams shaping a brand new product.
        </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <p class="leading-relaxed text-base" style="color:var(--text-muted);">
            Product teams and founders shaping a new digital product from an early idea.
          </p>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>An idea exists, but it has not been turned into a clear product plan.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>Early design decisions are being made without a strategy behind them.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The product risks feeling disjointed if design and development are not aligned early.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We shape products from early strategy through to a full design system
        </h2>
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @foreach ([
          ['t' => 'Digital Product Design from Strategy Through to Execution', 'd' => 'Digital product design from strategy through to execution, with a clear path from initial idea to launch ready design.'],
          ['t' => 'Product Design Company Experience Across Web, Mobile, and SaaS', 'd' => 'Product design company experience across web, mobile, and SaaS, with a process that adapts to different product types.'],
          ['t' => 'UX Product Design Grounded in Real User Needs', 'd' => 'UX product design grounded in real user needs, with research that shapes the product direction before visuals begin.'],
          ['t' => 'Software Product Design Aligned with Technical Feasibility', 'd' => 'Software product design aligned with technical feasibility, so designs are realistic for your engineering team to build.'],
          ['t' => 'Product Strategy and Design Working Together, Not Separately', 'd' => 'Product strategy and design working together, not separately, so the product plan and user experience stay aligned from day one.'],
        ] as $i => $offer)
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A clear product strategy tied to design decisions</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Wireframes and prototypes for early validation</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A full design system ready for development</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Ongoing design support as the product evolves</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Product strategy and definition</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>End to end product design</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Cross functional collaboration with engineering</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Design system development</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--navy-deep);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
        @foreach ([
          'A clear product strategy tied to design decisions',
          'Wireframes and prototypes for early validation',
          'A full design system ready for development',
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        ...
        <div class="h-full min-h-[320px]" style="background-image:url('https://images.unsplash.com/photo-1531498860502-7c5809f8c3e5?q=80&w=1200&auto=format&fit=crop'); background-size:cover; background-position:center;"></div>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'Do you help define the product strategy, or just the visuals?', 'a' => 'Both. Product strategy and design work together in our process, since good design depends on a clear strategy behind it.'],
          ['q' => 'Can you work with our existing product team?', 'a' => 'Yes. We often work alongside an existing product or founding team, adding design capacity and structure to the process.'],
          ['q' => 'Do you help define the product strategy, or just the visuals?', 'a' => 'Both. Product strategy and design work together in our process, since good design depends on a clear strategy behind it.'],
          ['q' => 'Can you work with our existing product or founding team?', 'a' => 'Yes. We often work alongside an existing team, adding design capacity and structure to the process.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to shape your product the right way from the start?</h2>
