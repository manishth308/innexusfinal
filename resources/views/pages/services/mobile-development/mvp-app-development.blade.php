    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 flex flex-col justify-center">
        ...
        <p class="text-base text-gray-400 leading-relaxed max-w-2xl font-normal mb-8">
          As part of our wider Mobile App Development practice, we scope MVP apps tightly around the core feature your idea depends on, so you can get the app in front of real users quickly, without spending months building features you may not need.
        </p>
