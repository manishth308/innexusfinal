...
<style>
  ...
  .mvp-page h1, .mvp-page h2, .mvp-page h3, .mvp-page .font-display{
  ...
  @media (prefers-reduced-motion: reduce){
    .mvp-page *{animation:none!important;transition:none!important;}
  }
</style>
@endpush

@section('content')
<div class="mvp-page bg-white">
  ...
  <header class="relative overflow-hidden text-white" style="background: radial-gradient(ellipse 900px 500px at 78% 20%, rgba(61,107,255,0.28), transparent 60%), var(--navy-deep);">
    <canvas id="mvpNodeCanvas"></canvas>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">MVP App Development</span>
      </nav>
      ...
      <div class="max-w-2xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          MVP App Development to <span style="color:var(--blue-bright);">Test Your Mobile Idea With Real Users</span>
        </h1>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We scope and build a focused MVP app around your core idea
        </h2>
      </div>
      ...
      <div class="grid gap-px border" style="background:var(--line); border-color:var(--line); grid-template-columns:repeat(auto-fit,minmax(260px,1fr));">
        @foreach ([
          'Mobile app mvp development scoped to core functionality',
          'Startup app development on a realistic timeline',
          'Prototype app development for early user testing',
          'Rapid app development without cutting corners on quality',
          'A minimum viable app built to expand later',
        ] as $offer)
          <div class="bg-white p-8 transition-colors duration-300 mvp-offer-card">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 bg-white border" style="border-color:var(--line);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A working MVP app ready for app store release or beta testing</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Core functionality scoped around your key hypothesis</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A technical foundation that can extend into the full app</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Basic analytics setup to track early user behavior</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 bg-white border" style="border-color:var(--line);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Lean mobile product scoping</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Rapid native or cross platform development</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Early stage app architecture planning</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>User feedback and iteration cycles</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'How is an MVP app different from a full app?', 'a' => 'An MVP focuses only on the core features needed to test your idea with real users, which keeps cost and time down while still producing a working product.'],
          ['q' => 'Can the MVP grow into the full app later?', 'a' => 'Yes. The MVP is built on the same foundation as a full app, so it can be extended instead of rebuilt.'],
          ['q' => 'Should our MVP app be native or cross platform?', 'a' => 'For most MVPs, cross platform development is faster and more cost effective, though we will confirm the right approach based on your specific idea.'],
          ['q' => 'Can the MVP be released as a public beta?', 'a' => "Yes. We can help set up a beta release through TestFlight or Google Play's beta testing tools."],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to test your app idea with real users?</h2>
...
<style>
  .mvp-offer-card:hover{
    background:var(--navy-deep) !important;
  }
  .mvp-offer-card:hover p{
    color:#fff !important;
  }
  .mvp-offer-card:hover div{
...
<script>
  (function () {
    var canvas = document.getElementById('mvpNodeCanvas');
    if (!canvas) return;
