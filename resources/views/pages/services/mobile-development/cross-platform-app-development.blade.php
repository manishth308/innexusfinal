...
<style>
  ...
  .xp-page h1, .xp-page h2, .xp-page h3, .xp-page .font-display{
  ...
  @media (prefers-reduced-motion: reduce){
    .xp-page *{animation:none!important;transition:none!important;}
  }
</style>
@endpush

@section('content')
<div class="xp-page bg-white">
  ...
  <header class="relative overflow-hidden text-white" style="background: radial-gradient(ellipse 900px 500px at 78% 20%, rgba(61,107,255,0.28), transparent 60%), var(--navy-deep);">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">Cross Platform App Development</span>
      </nav>
      ...
      <div class="max-w-2xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          Launch on <span style="color:var(--blue-bright);">iOS and Android together.</span>
        </h1>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We build cross platform apps from a single codebase that runs well on both iOS and Android
        </h2>
      </div>
      ...
      <div class="grid gap-px border" style="background:var(--line); border-color:var(--line); grid-template-columns:repeat(auto-fit,minmax(260px,1fr));">
        @foreach ([
          'Cross platform mobile app development from one shared codebase',
          'Flutter app development for fast, consistent performance',
          'React Native app development for teams already using React',
          'Hybrid app development where it fits the project',
          'Multi platform app development with a single maintenance path',
        ] as $offer)
          <div class="bg-white p-8 transition-colors duration-300 xp-offer-card">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 bg-white border" style="border-color:var(--line);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>One shared codebase running on both iOS and Android</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A consistent design and experience across platforms</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Simplified long term maintenance and updates</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>App store submission support for both platforms</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 bg-white border" style="border-color:var(--line);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Flutter development</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>React Native development</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Cross platform performance optimization</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Shared component and design system architecture</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        ...
        <div class="h-full min-h-[320px]" style="background-image:url('https://images.unsplash.com/photo-1551650975-87deedd944c3?q=80&w=1200&auto=format&fit=crop'); background-size:cover; background-position:center;"></div>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'Will a cross platform app feel native to users?', 'a' => 'Modern cross platform tools like Flutter and React Native get very close to native performance and feel. We will advise honestly if a native build makes more sense for your case.'],
          ['q' => 'Can you maintain the app after launch?', 'a' => 'Yes. Since cross platform apps share one codebase, updates and maintenance are simpler and faster to manage.'],
          ['q' => 'Will a cross platform app feel as good as a native one?', 'a' => 'Modern frameworks like Flutter and React Native get very close to native performance. We will tell you honestly if your specific project needs a native build instead.'],
          ['q' => 'Can we start cross platform and go native later if needed?', 'a' => 'It is possible, though it usually means a rebuild rather than a simple conversion, so it is worth deciding early if native is a hard requirement.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to launch on both platforms at once?</h2>
...
<style>
  ...
  .xp-offer-card:hover p{
    color:#fff !important;
  }
  .xp-offer-card:hover div{
...
<script>
  (function () {
    var canvas = document.getElementById('xpNodeCanvas');
    if (!canvas) return;
