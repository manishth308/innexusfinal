    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 flex flex-col justify-center">
        <nav class="flex items-center gap-2 text-sm font-medium text-purple-400 mb-6" aria-label="Breadcrumb">
          ...
          <a href="{{ url('/mobile-app-development') }}" class="hover:text-purple-300 transition-colors">Mobile App Development</a>
           <span class="text-gray-500">/</span>
           <span class="text-purple-400">Android App Development</span>
        </nav>

        <h1 class="text-4xl sm:text-6xl lg:text-[56px] font-extrabold text-white leading-[1.1] tracking-tight mb-6">
          Android App Development Built for <span class="text-purple-400">Real World Devices</span>
        </h1>
      ...
      <div class="lg:col-span-5 relative flex justify-center lg:justify-end items-center mt-8 lg:mt-0">
        <div class="relative w-full max-w-[520px] aspect-[4/3] lg:aspect-square">
          <img 
            src="https://images.unsplash.com/photo-1607252650355-f7fd0460ccdb?q=80&w=1000&auto=format&fit=crop" 
            alt="Android App Development - InTech Nexus" 
...
<section class="py-20 bg-[#0b0c10] border-t border-white/5">
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="mb-12">
      ...
      <p class="text-gray-400 text-lg">We build native Android apps designed to perform well across devices.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="group p-8 bg-white/[0.03] border border-purple-500/30 hover:border-purple-400 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.1)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Android App Development Company</h3>
          <p class="text-gray-400 leading-relaxed text-sm">Cross industry experience building Android apps for real users.</p>
        </div>
      </div>

      <div class="group p-8 bg-white/[0.03] border border-purple-500/30 hover:border-purple-400 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.1)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Custom Android App Development</h3>
          <p class="text-gray-400 leading-relaxed text-sm">Apps tailored for phones and tablets, built around your users and workflows.</p>
        </div>
      </div>

      <div class="group p-8 bg-white/[0.03] border border-purple-500/30 hover:border-purple-400 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.1)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Android Mobile App Development Using Kotlin</h3>
          <p class="text-gray-400 leading-relaxed text-sm">Modern Kotlin based apps that follow current Android development standards.</p>
        </div>
      </div>

      <div class="group p-8 bg-white/[0.03] border border-purple-500/30 hover:border-purple-400 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.1)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Native Android Development Built for Performance</h3>
          <p class="text-gray-400 leading-relaxed text-sm">Apps built natively for Android so performance and feel stay consistent.</p>
        </div>
      </div>
      ...
      <div class="group p-8 bg-white/[0.03] border border-purple-500/30 hover:border-purple-400 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.1)] transition-all duration-300 flex flex-col justify-between min-h-[220px] md:col-span-2">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Google Play Submission Support</h3>
          <p class="text-gray-400 leading-relaxed text-sm">End to end support through listing, review, and submission on Google Play.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3">
            ...
            <span>A fully native Android app for phones and tablets</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Google Play optimized listing and submission support</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Testing across a range of Android devices and OS versions</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Ongoing updates aligned with new Android releases</span>
          </li>
        </ul>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          ...
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Google Play submission and review process management</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="text-purple-400 mt-1">◦</span>
            <span>Device fragmentation testing and performance tuning</span>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="max-w-3xl mb-16">
      ...
      <p class="text-gray-400 text-lg leading-relaxed">
        A structured, transparent approach to building Android apps that perform on real devices.
      </p>
    </div>
  ...
  <div class="relative max-w-7xl mx-auto px-6 sm:px-12">
    <div class="grid grid-cols-1 lg:grid-cols-2 items-center">
      ...
      <div class="why-choose-image-frame">
        <img src="https://images.unsplash.com/photo-1607252650355-f7fd0460ccdb?q=80&w=1200&auto=format&fit=crop" alt="Why Choose InTech Nexus" class="why-choose-image">
      </div>
    </div>
  </div>
</section>
    ...
    <div class="space-y-4">
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 1 ? null : 1" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>Why build native instead of cross platform?</span>
        ...
        <div x-show="openFaq === 1" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Native apps generally perform better and feel more consistent with the platform. We will walk through the trade offs with you during discovery.
        </div>
      </div>
      ...
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 2 ? null : 2" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>Do you handle Google Play submission?</span>
        ...
        <div x-show="openFaq === 2" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Yes. Google Play submission support is part of our standard process.
        </div>
      </div>
      ...
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 3 ? null : 3" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>How many devices do you test on?</span>
        ...
        <div x-show="openFaq === 3" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          We test across a representative range of screen sizes, manufacturers, and OS versions, based on your target audience.
        </div>
      </div>
      ...
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 4 ? null : 4" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>Can you add Android specific features like widgets?</span>
        ...
        <div x-show="openFaq === 4" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Yes. We integrate Android specific features where they add real value to the app.
        </div>
      </div>
    </div>
  </div>
