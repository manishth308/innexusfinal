    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 flex flex-col justify-center">
        ...
        <h1 class="text-4xl sm:text-6xl lg:text-[56px] font-extrabold text-white leading-[1.1] tracking-tight mb-6">
          Mobile Apps Built for Real Use, <span class="text-purple-400">Not Just Demo Day</span>
        </h1>

        <p class="text-lg sm:text-xl text-gray-300 leading-relaxed max-w-2xl font-normal mb-8">
          Native iOS, native Android, and cross-platform apps built around how people actually use their phones. From launch through ongoing support.
        </p>
...
<section class="py-24 bg-[#0b0c10] border-t border-white/5">
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="max-w-3xl mb-16">
      ...
      <p class="text-gray-400 text-lg leading-relaxed">Explore the specific mobile app development services we offer.</p>
    </div>
    ...
    @php
        $childServices = [
            [
                ...
                'description' => 'Native iOS apps built with Swift, optimized for performance and the App Store review process.',
            ],
            [
                'title' => 'Android App Development',
                'slug' => 'android-app-development',
                'description' => 'Native Android apps built with Kotlin, designed for the full range of Android devices and OS versions.',
            ],
            [
                'title' => 'Cross Platform App Development',
                'slug' => 'cross-platform-app-development',
                'description' => 'One codebase, two platforms. Flutter and React Native builds that feel native without doubling the work.',
            ],
            [
                'title' => 'MVP App Development',
                'slug' => 'mvp-app-development',
                'description' => 'Fast, focused mobile MVPs that get a real, testable version of your app in front of users quickly.',
            ],
        ];
    @endphp
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
      <div class="text-white flex flex-col justify-center">
        ...
        <p class="text-gray-300 leading-relaxed max-w-md">
          Our mobile engineers work inside the same process as our design and QA teams. The app is not handed off at the end — design, build, and testing happen together. Need ongoing support after launch? We can also set up a dedicated mobile team for you.
        </p>
      </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
    <div class="bg-white/[0.03] border border-purple-500/40 p-10 md:p-16 shadow-[0_0_40px_rgba(168,85,247,0.2)] hover:shadow-[0_0_60px_rgba(168,85,247,0.35)] transition-all duration-300">
      ...
      <p class="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
        Book a call, request a proposal, or get a free quote to see what your app could look like.
      </p>
