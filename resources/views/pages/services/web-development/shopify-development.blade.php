...
<div class="wp-page bg-white">
  ...
  <header class="wp-hero relative overflow-hidden text-white">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">Shopify Development</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          Shopify Development Services Built Around Your Brand, <span style="color:var(--blue-bright);">Not a Template</span>
        </h1>
        <p class="text-lg text-white/70 leading-relaxed mb-4 max-w-2xl">
          Shopify development services for businesses that want a fast, reliable online store built on a proven ecommerce platform.
        </p>
        <p class="text-base text-white/60 leading-relaxed mb-10 max-w-2xl">
          As part of our wider Web Development practice, we treat Shopify as a flexible platform rather than a fixed template, building stores that reflect your brand fully and support the specific features your catalog and customers need.
        </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <p class="leading-relaxed text-base" style="color:var(--text-muted);">
            Businesses launching a new Shopify store, or looking to improve one they already have.
          </p>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>A default Shopify theme does not reflect the brand properly.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The current Shopify store is slow or difficult to manage.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>You need custom features that a standard Shopify theme cannot support.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We design and build Shopify stores tailored to your brand and catalog
        </h2>
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @foreach ([
          ['t' => 'Shopify Development Services from Setup Through to Launch', 'd' => 'Shopify development services covering store setup, customization, and launch with a clear plan from day one.'],
          ['t' => 'Shopify Development Company Experience Across Product Categories', 'd' => 'Shopify development company experience across product categories, with focus on conversion and performance.'],
          ['t' => 'Custom Shopify Development Beyond Standard Themes', 'd' => 'Custom Shopify development beyond standard themes, with tailored layouts and functionality for your brand.'],
          ['t' => 'Shopify Store Development with Custom Features and Apps', 'd' => 'Shopify store development with custom features and app integrations designed around your catalog and customers.'],
          ['t' => 'Shopify Website Design Built Around Your Brand', 'd' => 'Shopify website design built around your brand, with a store experience that feels consistent and professional.'],
        ] as $i => $offer)
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A fully built or customized Shopify store</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Custom features and app integrations</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A checkout and browsing experience built around your catalog</span></li>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Custom Shopify theme development</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Shopify app integration and configuration</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Shopify Plus experience for larger catalogs</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Store migration to Shopify</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--navy-deep);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
        @foreach ([
          'A fully built or customized Shopify store',
          'Custom features and app integrations',
          'A checkout and browsing experience built around your catalog',
          'Ongoing support for updates and new features',
        ] as $outcome)
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        <div class="p-10 md:p-16 text-white h-full flex flex-col justify-center" style="background:var(--navy-deep);">
          ...
          <h2 class="text-3xl md:text-4xl font-bold mt-4 mb-6">A Shopify agency that treats the platform as flexible, not fixed</h2>
          <p class="text-white/70 leading-relaxed max-w-md">
            As a Shopify agency, we treat Shopify as a flexible platform, not a fixed template. That means the store can reflect your brand fully and support the specific features your catalog needs.
          </p>
        </div>
        <div class="h-full min-h-[320px]" style="background-image:url('https://images.unsplash.com/photo-1556742049-0cf9c6f7c36e?q=80&w=1200&auto=format&fit=crop'); background-size:cover; background-position:center;"></div>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'Can you customize our existing Shopify theme?', 'a' => 'Yes. We can customize an existing theme or build a fully custom Shopify design, depending on your goals and budget.'],
          ['q' => 'Do you set up Shopify apps and integrations?', 'a' => 'Yes. We set up and configure the Shopify apps and integrations your store needs to run smoothly.'],
          ['q' => 'Can you customize our existing Shopify theme instead of starting over?', 'a' => 'Yes. We can customize an existing theme or build a fully custom design, depending on your goals and budget.'],
          ['q' => 'Do you set up Shopify apps for things like reviews or subscriptions?', 'a' => 'Yes. We set up and configure the Shopify apps your store needs, and can recommend options if you are not sure what you need.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to build or improve your Shopify store?</h2>
