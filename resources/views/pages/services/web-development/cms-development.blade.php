@extends('layouts.app')
@section('title', 'CMS Development Services - InTech Nexus')
...
<div class="wp-page bg-white">
  ...
  <header class="wp-hero relative overflow-hidden text-white">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">CMS Development</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          CMS Development Services That Put Your Team <span style="color:var(--blue-bright);">Back in Control</span>
        </h1>
        <p class="text-lg text-white/70 leading-relaxed mb-4 max-w-2xl">
          CMS development services for businesses that need full control over their website content without relying on a developer for every change.
        </p>
        <p class="text-base text-white/60 leading-relaxed mb-10 max-w-2xl">
          As part of our wider Web Development practice, we build and customize content management systems so your team can update the site without waiting on a developer for every small change. This makes CMS development a strong fit for businesses that publish content regularly or manage a growing site.
        </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <p class="leading-relaxed text-base" style="color:var(--text-muted);">
            Businesses that need a content managed website their own team can update easily.
          </p>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>Updating the current website requires a developer for even small changes.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>Content is spread across disconnected tools and hard to manage.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>You need a content system flexible enough to grow with the business.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We build and customize content management systems around your team's needs
        </h2>
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @foreach ([
          ['t' => 'Custom CMS Development Tailored to Your Content Structure', 'd' => 'Custom CMS development tailored to your content structure, workflow, and publishing requirements.'],
          ['t' => 'Content Management System Development for Growing Sites', 'd' => 'Content management system development for growing sites that need to scale without losing editorial control.'],
          ['t' => 'CMS Website Development with an Easy to Use Editor', 'd' => 'CMS website development with an easy to use editor that your team can adopt without extensive training.'],
          ['t' => 'Headless CMS Development for Flexible, Multi Channel Content', 'd' => 'Headless CMS development for flexible, multi channel content delivery across web, mobile, and other platforms.'],
          ['t' => 'CMS Solution Company Support After Launch', 'd' => 'CMS solution company support after launch, with documentation and guidance for your content team.'],
        ] as $i => $offer)
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A fully configured content management system</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A clear, simple editing experience for your team</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Custom content structures built around your needs</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Documentation or training for your content team</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>CMS architecture and customization</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Headless and traditional CMS implementation</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Content modeling</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Editor experience design</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--navy-deep);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
        @foreach ([
          'A fully configured content management system',
          'A clear, simple editing experience for your team',
          'Custom content structures built around your needs',
          'Documentation or training for your content team',
        ] as $outcome)
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        <div class="p-10 md:p-16 text-white h-full flex flex-col justify-center" style="background:var(--navy-deep);">
          ...
          <h2 class="text-3xl md:text-4xl font-bold mt-4 mb-6">Built for the people who actually use the CMS every day</h2>
          <p class="text-white/70 leading-relaxed max-w-md">
            We build CMS platforms with your actual content team in mind, not just developers. That means a clear, simple editing experience your team can use without needing technical help for routine updates.
          </p>
        </div>
        <div class="h-full min-h-[320px]" style="background-image:url('https://images.unsplash.com/photo-1499750310107-5fef28a66643?q=80&w=1200&auto=format&fit=crop'); background-size:cover; background-position:center;"></div>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'Which CMS platforms do you work with?', 'a' => 'We work with WordPress, headless CMS platforms, and other systems, chosen based on what fits your content needs and technical requirements.'],
          ['q' => 'Can our team manage the site without a developer?', 'a' => 'Yes. The CMS is set up so your team can make routine content updates without needing to call a developer each time.'],
          ['q' => 'Which CMS do you recommend?', 'a' => 'It depends on your content needs and technical requirements. We often recommend WordPress for flexibility, or a headless CMS for multi channel content.'],
          ['q' => 'Can you migrate our existing content into a new CMS?', 'a' => 'Yes. Content migration is part of our standard CMS development process.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready for a CMS your team can actually manage?</h2>
