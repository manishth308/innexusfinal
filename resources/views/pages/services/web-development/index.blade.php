...
<style>
  ...
  .webdev-page h1, .webdev-page h2, .webdev-page h3, .webdev-page .font-display{
    font-family:'Space Grotesk',sans-serif;
    letter-spacing:-0.01em;
  }
  .webdev-page .font-mono{
  ...
  .marquee-track{
    display:flex;
    width:max-content;
    animation:webdev-marquee 26s linear infinite;
  }
  @keyframes webdev-marquee{
    from{ transform:translateX(0); }
    to{ transform:translateX(-50%); }
  }
  @media (prefers-reduced-motion: reduce){
    .webdev-page *{ animation:none!important; transition:none!important; }
...
@section('content')
<div class="webdev-page bg-white">

  <!-- ===== Hero ===== -->
  <header class="webdev-hero relative overflow-hidden text-white">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">Web Development</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          Web Development Services Built for <span style="color:var(--blue-bright);">Speed, Structure, and Search</span>
        </h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The current website is slow, outdated, or hard to update.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The design looks fine, but the site is not bringing in leads or ranking in search.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>You need a custom web app, not just a marketing site.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We build responsive, fast websites and web apps on a modern, reliable base
        </h2>
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @foreach ([
          ['t' => 'Company and marketing websites', 'd' => 'Built on clean, search friendly site structure and code from day one.'],
          ['t' => 'Custom web applications', 'd' => 'Full frontend and backend web development for needs beyond a template.'],
          ['t' => 'Ecommerce storefronts', 'd' => 'CMS setup so your team can manage products and content easily.'],
          ['t' => 'WordPress and custom CMS builds', 'd' => 'CMS implementation and customization suited to how your team works.'],
          ['t' => 'Web portals and client dashboards', 'd' => 'Backed by technical SEO and site architecture best practices.'],
          ['t' => 'Site migrations and speed improvements', 'd' => 'Site migrations with rankings protected, plus ongoing performance optimization.'],
        ] as $i => $offer)
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A fully built, responsive website or web application</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Clean, search friendly site structure and code</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>CMS setup so your team can manage content easily</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Site migrations with rankings protected</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Frontend and backend web development</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Technical SEO and site architecture</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>CMS implementation and customization</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Site performance optimization</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--navy-deep);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
        @foreach ([
          'A fully built, responsive website or web application',
          'Clean, search friendly site structure and code',
          'CMS setup so your team can manage content easily',
          'Site migrations with rankings protected',
        ] as $outcome)
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        <div class="p-10 md:p-16 text-white h-full flex flex-col justify-center" style="background:var(--navy-deep);">
          ...
          <h2 class="text-3xl md:text-4xl font-bold mt-4 mb-6">Built with search visibility in mind from day one</h2>
          <p class="text-white/70 leading-relaxed max-w-md">
            Every website we build is planned with Digital Marketing in mind from the start. Clean links, a good structure, and search basics are part of the build, not added later.
          </p>
        </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'Will a new website hurt our search rankings?', 'a' => 'No. Migrations are planned with redirects and search settings built into the launch checklist to protect your rankings.'],
          ['q' => 'Can you work with our existing brand?', 'a' => 'Yes. We can build within your current brand, or work with our Branding team if it needs more work first.'],
          ['q' => 'How long does a typical website project take?', 'a' => 'It depends on scope, but most marketing websites are completed within a few weeks, while larger web applications take longer based on complexity.'],
          ['q' => 'Will the site be easy for our team to update?', 'a' => 'Yes. We build on content systems that let your team make routine updates without needing a developer each time.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to build a website that actually performs?</h2>
