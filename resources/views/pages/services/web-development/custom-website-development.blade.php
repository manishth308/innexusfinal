@extends('layouts.app')
@section('title', 'Custom Website Development Services - InTech Nexus')
...
<style>
  ...
  .cwd-page h1, .cwd-page h2, .cwd-page h3, .cwd-page .font-display{
  ...
  .marquee-track{
    display:flex;
    width:max-content;
    animation:cwd-marquee 26s linear infinite;
  }
  ...
  @media (prefers-reduced-motion: reduce){
    .cwd-page *{ animation:none!important; transition:none!important; }
...
@section('content')
<div class="cwd-page bg-white">

  <!-- ===== Hero ===== -->
  <header class="cwd-hero relative overflow-hidden text-white">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">Custom Website Development</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          Custom Website Development <span style="color:var(--blue-bright);">Planned Around Your Goals, Not a Template</span>
        </h1>
        <p class="text-lg text-white/70 leading-relaxed mb-4 max-w-2xl">
          Custom website development services for businesses that need a website built around their exact goals, not a generic template.
        </p>
        <p class="text-base text-white/60 leading-relaxed mb-10 max-w-2xl">
          As part of our wider Web Development practice, we plan every custom website around your specific goals, content, and audience, rather than starting from a generic layout. This keeps the site fast, easy to maintain, and built to actually support the business outcomes you care about.
        </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <p class="leading-relaxed text-base" style="color:var(--text-muted);">
            Businesses that need a new website, or want to replace a template based site that is not performing.
          </p>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>A template website looks generic and does not reflect the business properly.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The current site is slow, hard to update, or not built for search.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>You need a website that is planned around your specific goals, not a one size fits all layout.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We plan and build custom websites on a modern, reliable base
        </h2>
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @foreach ([
          ['t' => 'Custom website development services planned around your goals', 'd' => 'A fully custom website built around your business goals, not a generic layout.'],
          ['t' => 'Website development company experience across industries', 'd' => 'Backed by information architecture and site planning across a range of industries.'],
          ['t' => 'Business website development for growing companies', 'd' => 'A content system your team can manage independently as the business grows.'],
          ['t' => 'Responsive website development across devices', 'd' => 'A responsive design that works across every device, built on custom frontend and backend development.'],
          ['t' => 'Custom web solutions beyond a standard template', 'd' => 'Search friendly structure and on page SEO fundamentals built in from the start.'],
        ] as $i => $offer)
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A fully custom website built around your business goals</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A responsive design that works across every device</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A content system your team can manage independently</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Search friendly structure built in from the start</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Custom frontend and backend development</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Information architecture and site planning</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Responsive design implementation</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>On page SEO fundamentals</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--navy-deep);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
        @foreach ([
          'A fully custom website built around your business goals',
          'A responsive design that works across every device',
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        <div class="p-10 md:p-16 text-white h-full flex flex-col justify-center" style="background:var(--navy-deep);">
          ...
          <h2 class="text-3xl md:text-4xl font-bold mt-4 mb-6">Structure and search basics, built in from the start</h2>
          <p class="text-white/70 leading-relaxed max-w-md">
            Every custom website we build is planned with structure and search basics in mind from the start, not decorated after the fact. This keeps the site fast, easy to update, and built to actually bring in leads.
          </p>
        </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'How is a custom website different from a template site?', 'a' => 'A template site is built for a general audience. A custom website is planned around your specific goals, content, and brand, so it fits your business exactly.'],
          ['q' => 'Will the new website be easy for our team to update?', 'a' => 'Yes. We build on content systems that let your team make updates without needing a developer for every change.'],
          ['q' => 'Do you write the website content too?', 'a' => 'Content can be supported through our Content Marketing service, or we can build the site around content you already have.'],
          ['q' => 'Can the site grow as our business grows?', 'a' => 'Yes. We plan the structure with future pages and features in mind, so the site does not need a full rebuild every time you grow.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to build a website planned around your goals?</h2>
