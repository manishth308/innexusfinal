@extends('layouts.app')
@section('title', 'WordPress Development Services - InTech Nexus')
...
<div class="wp-page bg-white">
  ...
  <header class="wp-hero relative overflow-hidden text-white">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">WordPress Development</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          WordPress Development Built for <span style="color:var(--blue-bright);">Performance and Flexibility</span>
        </h1>
        <p class="text-lg text-white/70 leading-relaxed mb-4 max-w-2xl">
          WordPress development services for businesses that need a fast, secure, and easy to manage website built on the world's most popular CMS.
        </p>
        <p class="text-base text-white/60 leading-relaxed mb-10 max-w-2xl">
          As part of our wider Web Development practice, we build WordPress sites around your content and business goals, not just template layouts. That means a custom theme, optimized backend, and clear admin experience that lets your team update content easily, whether you are launching a new site or replacing one that is hard to manage.
        </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <p class="leading-relaxed text-base" style="color:var(--text-muted);">
            Businesses launching a new WordPress site, or replacing an existing one that is slow, insecure, or hard to update.
          </p>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The current WordPress site uses a generic theme and does not reflect the brand or business properly.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The site is slow, not optimized for search, or difficult to update without a developer.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>You need a WordPress site that can grow with your business without rebuilding later.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We plan and build WordPress sites on a modern, reliable base
        </h2>
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @foreach ([
          ['t' => 'Custom WordPress Theme Development', 'd' => 'A fully custom WordPress theme built around your brand and business goals, not a generic template.'],
          ['t' => 'WordPress Development Company Experience', 'd' => 'WordPress development experience across industries, with focus on performance and security.'],
          ['t' => 'WooCommerce Development', 'd' => 'WooCommerce development for online stores that need to sell through WordPress.'],
          ['t' => 'WordPress Plugin Development and Integration', 'd' => 'Custom WordPress plugin development and third party integrations tailored to your workflow.'],
          ['t' => 'WordPress Website Development with SEO in Mind', 'd' => 'WordPress website development with performance and SEO fundamentals built in from the start.'],
        ] as $i => $offer)
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A fully custom WordPress theme built around your brand</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Performance and speed optimization out of the box</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>SEO friendly structure built in from the start</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Ongoing support for updates and new features</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Custom WordPress theme and plugin development</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>WooCommerce and ecommerce functionality</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>WordPress performance and security optimization</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Headless WordPress and API integrations</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--navy-deep);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
        @foreach ([
          'A fully custom WordPress theme built around your brand',
          'Performance and speed optimization out of the box',
          'SEO friendly structure built in from the start',
          'A content system your team can manage independently',
        ] as $outcome)
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        <div class="p-6 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <p class="text-sm font-medium" style="color:var(--navy-deep);">WordPress · WooCommerce · Headless CMS</p>
        </div>
        <div class="p-6 border" style="border-color:var(--line); background:var(--bg-soft);">
          <p class="font-mono text-xs uppercase tracking-wider mb-3" style="color:var(--blue-accent);">Frontend</p>
          <p class="text-sm font-medium" style="color:var(--navy-deep);">React · Next.js · PHP</p>
        </div>
        <div class="p-6 border" style="border-color:var(--line); background:var(--bg-soft);">
          <p class="font-mono text-xs uppercase tracking-wider mb-3" style="color:var(--blue-accent);">Backend</p>
          <p class="text-sm font-medium" style="color:var(--navy-deep);">Node.js · PHP · MySQL</p>
        </div>
        <div class="p-6 border" style="border-color:var(--line); background:var(--bg-soft);">
  ...
  <section class="py-14 border-t overflow-hidden" style="border-color:var(--line); background:var(--bg-soft);">
    ...
    <div class="relative">
      <div class="marquee-track">
        @for ($rep = 0; $rep < 2; $rep++)
          @foreach ([
            'WordPress', 'WooCommerce', 'Headless CMS', 'React', 'Next.js', 'Node.js', 'PHP', 'AWS', 'Cloudflare', 'Google Analytics', 'Search Console',
          ] as $tag)
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        <div class="p-10 md:p-16 text-white h-full flex flex-col justify-center" style="background:var(--navy-deep);">
          ...
          <h2 class="text-3xl md:text-4xl font-bold mt-4 mb-6">Structure and flexibility, built in from the start</h2>
          <p class="text-white/70 leading-relaxed max-w-md">
            Every WordPress site we build is planned with structure and search basics in mind from the start, not decorated after the fact. This keeps the site fast, easy to update, and built to actually bring in leads.
          </p>
        </div>
        <div class="h-full min-h-[320px]" style="background-image:url('https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?q=80&w=1200&auto=format&fit=crop'); background-size:cover; background-position:center;"></div>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 border-t" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'Can you build a custom WordPress theme from scratch?', 'a' => 'Yes. We can build a fully custom WordPress theme tailored to your brand and business goals, rather than customizing an existing template.'],
          ['q' => 'Can the WordPress site handle a large content catalog?', 'a' => 'Yes. We plan the site structure and backend to handle catalog growth without needing a rebuild later.'],
          ['q' => 'Do you offer WooCommerce development on WordPress?', 'a' => 'Yes. We can build and customize WooCommerce stores on WordPress, from product catalogs to checkout flows.'],
          ['q' => 'Can the site integrate with our existing tools and CRM?', 'a' => 'Yes. We can integrate WordPress with most third party tools, CRMs, and APIs.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to build a WordPress site that is fast, secure, and easy to manage?</h2>
