@extends('layouts.app')
@section('title', 'Content Marketing Services - InTech Nexus')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 flex flex-col justify-center">
        <nav class="flex items-center gap-2 text-sm font-medium text-purple-400 mb-6" aria-label="Breadcrumb">
          ...
          <span class="text-gray-500">/</span>
          <span class="text-purple-400">Content Marketing</span>
        </nav>

        <h1 class="text-4xl sm:text-6xl lg:text-[56px] font-extrabold text-white leading-[1.1] tracking-tight mb-6">
          Content Marketing Services That Bring In Traffic Worth Having
        </h1>

        <p class="text-lg sm:text-xl text-gray-300 leading-relaxed max-w-2xl font-normal mb-4">
          Content marketing services for businesses that want their website and blog to actually bring in visitors and leads.
        </p>
        <p class="text-base text-gray-400 leading-relaxed max-w-2xl font-normal mb-8">
          As part of our wider Digital Marketing practice, we plan content around what people are actually searching for, not just topics that sound interesting, so the effort stays tied to real traffic and lead generation instead of publishing for its own sake.
        </p>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 flex flex-col justify-between">
        <div>
          ...
          <p class="text-gray-300 leading-relaxed text-base">
            Businesses that need a steady stream of content built to support search visibility and lead generation.
          </p>
        </div>
      </div>
        ...
        <div>
          ...
          <ul class="space-y-3 text-gray-300">
            <li class="flex items-start gap-3">
              ...
              <span>The blog exists but is not bringing in traffic or leads.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-purple-400 mt-1">◦</span>
              <span>Content is being published without a clear strategy behind it.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-purple-400 mt-1">◦</span>
              <span>There is no time or resource in house to keep up with content needs.</span>
            </li>
          </ul>
        </div>
      </div>
...
<section class="py-20 bg-[#0b0c10] border-t border-white/5">
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="mb-12">
      ...
      <p class="text-gray-400 text-lg">Content and SEO programs engineered for search visibility and audience growth.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Content Strategy & SEO</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">Content planned around real search demand</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Keyword and topic research</li>
            <li>• Editorial calendar and content planning</li>
            <li>• SEO optimization for blogs and landing pages</li>
          </ul>
        </div>
      </div>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Content Production</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">High-quality content across formats</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Long-form articles and guides</li>
            <li>• Landing page copy and optimization</li>
            <li>• Social content and repurposing</li>
          </ul>
        </div>
      </div>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Email Marketing</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">Nurture leads with automated email</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Automated nurture sequences</li>
            <li>• Newsletter strategy and design</li>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Performance & CRO</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">Turn content into conversions</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Content performance tracking</li>
            <li>• A/B testing for headlines and CTAs</li>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>A content strategy tied to search demand and business goals</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Regularly published, SEO optimized content</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Content structured to support lead generation</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Performance tracking tied to traffic and conversions</span></li>
        </ul>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Content strategy and planning</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>SEO driven content writing</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Editorial calendar management</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Content performance analysis</span></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="max-w-3xl mb-16">
      ...
      <p class="text-gray-400 text-lg leading-relaxed">
        A structured approach to content marketing that ties every piece of content to search demand and business outcomes.
      </p>
    </div>
    ...
    <div class="space-y-6">
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Research & Strategy</h3>
          <p class="text-gray-300">We research your audience, competitors, and search landscape to build a content strategy aligned with your business goals.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Content Planning & Creation</h3>
          <p class="text-gray-300">We develop an editorial calendar and produce high-quality content optimized for search, engagement, and conversions.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Publishing & Distribution</h3>
          <p class="text-gray-300">We publish on a consistent schedule and distribute content across relevant channels to maximize reach and traffic.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Measurement & Optimization</h3>
          <p class="text-gray-300">We track content performance against traffic, leads, and rankings, refining strategy based on real data.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Iteration & Growth</h3>
          <p class="text-gray-300">We continuously improve content based on performance insights, expanding what works and testing new formats.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 items-center">
      <div class="p-10 md:p-16 text-white flex flex-col justify-center">
        ...
        <p class="text-gray-300 leading-relaxed max-w-md">
          Content here is planned around what people are actually searching for, not just topics that sound interesting. That keeps the content marketing effort tied to real traffic and lead generation, not just publishing for its own sake.
        </p>
      </div>
      <div class="why-choose-image-frame">
        <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=1200&auto=format&fit=crop" alt="Why Choose InTech Nexus" class="why-choose-image">
      </div>
    </div>
  </div>
</section>
    ...
    <div class="space-y-4">
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 1 ? null : 1" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>How much content do we need to publish?</span>
        ...
        <div x-show="openFaq === 1" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          This depends on your goals and competition. We will recommend a realistic content cadence during strategy, based on what the site actually needs.
        </div>
      </div>
      ...
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 2 ? null : 2" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>Do you handle the writing, or just the strategy?</span>
        ...
        <div x-show="openFaq === 2" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Both. We handle content strategy and writing together, so the plan and the execution stay connected.
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
    <div class="bg-white/[0.03] border border-purple-500/40 p-10 md:p-16 shadow-[0_0_40px_rgba(168,85,247,0.2)] hover:shadow-[0_0_60px_rgba(168,85,247,0.35)] transition-all duration-300">
      <h2 class="text-3xl md:text-5xl font-extrabold text-white mb-6">
        Ready for content that actually brings in traffic?
      </h2>
