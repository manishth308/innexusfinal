...
<div class="dm-page bg-white">
  ...
  <header class="dm-hero relative overflow-hidden text-white">
    ...
    <!-- Floating Content Marketing graphic -->
    <div class="absolute right-10 top-1/2 -translate-y-1/2 hidden lg:block float-graphic" aria-hidden="true">
      <svg width="280" height="280" viewBox="0 0 280 280" fill="none">
        ...
        <text x="140" y="145" text-anchor="middle" fill="rgba(255,255,255,0.9)" font-family="IBM Plex Mono, monospace" font-size="14" font-weight="600">Content</text>
      </svg>
    </div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">Content Marketing</span>
      </nav>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The blog exists but is not bringing in traffic or leads.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>Content is being published without a clear strategy behind it.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>There is no time or resource in house to keep up with content needs.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We plan and produce content built around search intent and business goals
        </h2>
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @foreach ([
          ['t' => 'Content Strategy Services Aligned with Your Business Goals', 'd' => 'Content strategy services aligned with your business goals, ensuring every piece of content serves a clear purpose.'],
          ['t' => 'SEO Content Marketing Built Around Real Search Demand', 'd' => 'SEO content marketing built around real search demand, targeting terms and topics that your audience is actively searching for.'],
          ['t' => 'Blog Writing Services on a Consistent Schedule', 'd' => 'Blog writing services on a consistent schedule, keeping your audience engaged with fresh, valuable content.'],
          ['t' => 'Website Content Marketing Beyond Just the Blog', 'd' => 'Website content marketing beyond just the blog, optimizing landing pages, service pages, and core content for conversions.'],
          ['t' => 'Content Creation Agency Support Across Formats', 'd' => 'Content creation agency support across formats, from long form articles to social content and more.'],
        ] as $i => $offer)
  ...
  <section class="py-20 border-t fade-up" style="border-color:var(--line); background:var(--navy-deep);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
        @foreach ([
          ['v' => '100%', 'l' => 'Search driven content'],
          ['v' => '2x', 'l' => 'Average traffic growth'],
          ['v' => '50+', 'l' => 'Content strategies delivered'],
          ['v' => '24/7', 'l' => 'Performance tracking'],
        ] as $stat)
          <div class="p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A content strategy tied to search demand and business goals</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Regularly published, SEO optimized content</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Content structured to support lead generation</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Performance tracking tied to traffic and conversions</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Content strategy and planning</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>SEO driven content writing</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Editorial calendar management</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Content performance analysis</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t fade-up" style="border-color:var(--line); background:var(--navy-deep);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
        @foreach ([
          'A content strategy tied to search demand and business goals',
          'Regularly published, SEO optimized content',
          'Content structured to support lead generation',
          'Performance tracking tied to traffic and conversions',
        ] as $outcome)
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        <div class="p-10 md:p-16 text-white h-full flex flex-col justify-center" style="background:var(--navy-deep);">
          ...
          <h2 class="text-3xl md:text-4xl font-bold mt-4 mb-6">Content planned around what people are actually searching for</h2>
  ...
  <section class="py-24 border-t fade-up" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'How much content do we need to publish?', 'a' => 'This depends on your goals and competition. We will recommend a realistic content cadence during strategy, based on what the site actually needs.'],
          ['q' => 'Do you handle the writing, or just the strategy?', 'a' => 'Both. We handle content strategy and writing together, so the plan and the execution stay connected.'],
          ['q' => 'How much content do we need to publish?', 'a' => 'This depends on your goals and competition. We will recommend a realistic content cadence during strategy, based on what the site actually needs.'],
          ['q' => 'Do you handle the writing, or just the strategy?', 'a' => 'Both. We handle content strategy and writing together, so the plan and the execution stay connected, alongside our SEO Services.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t fade-up" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready for content that actually brings in traffic?</h2>
