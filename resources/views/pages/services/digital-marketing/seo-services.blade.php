...
<div class="dm-page bg-white">
  ...
  <header class="dm-hero relative overflow-hidden text-white">
    ...
    <div class="absolute right-10 top-1/2 -translate-y-1/2 hidden lg:block float-graphic" aria-hidden="true">
      <svg width="280" height="280" viewBox="0 0 280 280" fill="none">
        ...
        <text x="140" y="145" text-anchor="middle" fill="rgba(255,255,255,0.9)" font-family="IBM Plex Mono, monospace" font-size="14" font-weight="600">SEO</text>
      </svg>
    </div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 pt-14 pb-24 lg:pt-16 lg:pb-28">
      ...
      <nav class="flex flex-wrap items-center gap-2 text-sm font-medium mb-8" style="color:var(--blue-bright);" aria-label="Breadcrumb">
        ...
        <span class="text-white/30">/</span>
        <span class="text-white/70">SEO Services</span>
      </nav>
      ...
      <div class="max-w-3xl">
        ...
        <h1 class="text-4xl sm:text-4xl lg:text-[50px] font-bold leading-[1.1] mt-5 mb-6">
          SEO Services That Get You Found by People <span style="color:var(--blue-bright);">Already Searching</span>
        </h1>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>The website is not showing up in search results for relevant terms.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>Competitors are ranking above the business for the same searches.</span></li>
            <li class="flex items-start gap-3"><span class="font-bold" style="color:var(--blue-accent);">•</span><span>Past SEO work has not produced a clear, measurable return.</span></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="mb-12 max-w-xl">
        ...
        <h2 class="text-3xl md:text-4xl font-bold mt-3" style="color:var(--navy-deep);">
          We run full SEO programs built around real search behavior
        </h2>
      </div>

      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @foreach ([
          ['t' => 'SEO Agency Experience Across Industries and Business Sizes', 'd' => 'SEO agency experience across industries and business sizes, with strategies adapted to your market and competition.'],
          ['t' => 'Search Engine Optimization Services Covering Technical and Content Work', 'd' => 'Search engine optimization services covering technical and content work, so the full site is optimized, not just a few pages.'],
          ['t' => 'Technical SEO Services to Fix Crawlability and Site Health', 'd' => 'Technical SEO services to fix crawlability and site health issues that keep search engines from indexing your content properly.'],
          ['t' => 'On Page SEO Services for Content and Page Structure', 'd' => 'On page SEO services for content and page structure, so each page is built around the terms and intent of your audience.'],
          ['t' => 'Organic Traffic Growth Tracked Against Clear Goals', 'd' => 'Organic traffic growth tracked against clear goals, with reporting that shows how SEO connects to leads and revenue.'],
        ] as $i => $offer)
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>A full SEO audit and prioritized action plan</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Technical fixes for crawlability and site health</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>On page optimization across key pages</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Ongoing tracking of rankings and organic traffic</span></li>
          </ul>
        </div>
        ...
        <div class="p-8 border" style="border-color:var(--line); background:var(--bg-soft);">
          ...
          <ul class="space-y-3 text-sm" style="color:var(--text-muted);">
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Technical SEO</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>Keyword research and content strategy</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>On page and off page optimization</span></li>
            <li class="flex items-start gap-3"><span style="color:var(--blue-accent);">◦</span><span>SEO performance tracking and reporting</span></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="py-24 border-t fade-up" style="border-color:var(--line); background:var(--navy-deep);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      ...
      <div class="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl">
        @foreach ([
          'A full SEO audit and prioritized action plan',
          'Technical fixes for crawlability and site health',
          'On page optimization across key pages',
          'Ongoing tracking of rankings and organic traffic',
        ] as $outcome)
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-12">
      <div class="grid grid-cols-1 lg:grid-cols-2 items-center overflow-hidden" style="border-radius:2px;">
        <div class="p-10 md:p-16 text-white h-full flex flex-col justify-center" style="background:var(--navy-deep);">
          ...
          <h2 class="text-3xl md:text-4xl font-bold mt-4 mb-6">SEO planned with the actual website team, not handed over as a report</h2>
        ...
        <div class="h-full min-h-[320px]" style="background-image:url('https://images.unsplash.com/photo-1562577309-4932c2d88f1e?q=80&w=1200&auto=format&fit=crop'); background-size:cover; background-position:center;"></div>
      </div>
    </div>
  </section>
  ...
  <section class="py-24 border-t fade-up" style="border-color:var(--line); background:var(--bg-soft);" x-data="{ openFaq: null }">
    <div class="max-w-5xl mx-auto px-6 sm:px-12">
      ...
      <div class="space-y-4">
        @foreach ([
          ['q' => 'How long does SEO take to show results?', 'a' => 'SEO builds over time. Meaningful movement typically takes a few months, depending on competition and the current state of the site.'],
          ['q' => 'Do you handle both technical SEO and content?', 'a' => 'Yes. Our SEO services cover technical fixes, on page optimization, and content strategy together, working closely with Content Marketing.'],
          ['q' => 'How long does SEO take to show results?', 'a' => 'SEO builds over time. Meaningful movement typically takes a few months, depending on competition and the current state of the site.'],
          ['q' => 'Do you handle both technical SEO and content?', 'a' => 'Yes. Our SEO services cover technical fixes, on page optimization, and content strategy together, working closely with Content Marketing.'],
        ] as $i => $faq)
  ...
  <section class="py-24 border-t fade-up" style="border-color:var(--line);">
    <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
      <div class="p-10 md:p-16 text-white" style="background:var(--navy-deep); border-radius:2px;">
        <h2 class="text-3xl md:text-5xl font-bold mb-6">Ready to start ranking for the searches that matter?</h2>
