    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 flex flex-col justify-center">
        <nav class="flex items-center gap-2 text-sm font-medium text-purple-400 mb-6" aria-label="Breadcrumb">
          ...
          <span class="text-gray-500">/</span>
          <span class="text-purple-400">Conversion Rate Optimization</span>
        </nav>
        ...
        <div>
          ...
          <ul class="space-y-3 text-gray-300">
            <li class="flex items-start gap-3">
              ...
              <span>Traffic is steady, but conversions are not improving.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-purple-400 mt-1">◦</span>
              <span>It is unclear which parts of the site or funnel are causing drop off.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-purple-400 mt-1">◦</span>
              <span>Changes have been made to the site without any real testing behind them.</span>
            </li>
          </ul>
        </div>
      </div>
...
<section class="py-20 bg-[#0b0c10] border-t border-white/5">
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="mb-12">
      ...
      <p class="text-gray-400 text-lg">CRO programs engineered for data-backed conversion improvements.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">CRO Audits & Analysis</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">Identify where revenue is leaking</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Funnel and drop-off analysis</li>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Landing Page Optimization</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">Pages built to convert traffic</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Headline, CTA, and layout testing</li>
            <li>• Form optimization and friction reduction</li>
            <li>• Mobile and load speed improvements</li>
          </ul>
        </div>
      </div>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">A/B Testing & Experimentation</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">Validate changes with real data</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Multivariate and split testing</li>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors"> funnel Strategy</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">Optimize every stage of the journey</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Awareness to purchase funnel mapping</li>
            <li>• Checkout and cart recovery</li>
            <li>• Post-purchase retention tactics</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>A full conversion audit of your site or funnel</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Prioritized recommendations based on impact</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>A/B tested changes before full rollout</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Ongoing optimization based on real user data</span></li>
        </ul>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Conversion funnel analysis</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Landing page optimization</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>A/B and multivariate testing</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>User behavior analysis</span></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="max-w-3xl mb-16">
      ...
      <p class="text-gray-400 text-lg leading-relaxed">
        A structured, evidence-based approach to improving conversion rates through testing, analysis, and iterative optimization.
      </p>
    </div>
    ...
    <div class="space-y-6">
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Audit & Data Review</h3>
          <p class="text-gray-300">We analyze analytics, heatmaps, and user recordings to identify where visitors drop off and why.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Hypothesis & Prioritization</h3>
          <p class="text-gray-300">We develop data-backed hypotheses and prioritize changes by potential impact and ease of implementation.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Design & Development</h3>
          <p class="text-gray-300">We build test variants and implement changes with clean, maintainable code that does not affect site performance.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Testing & Validation</h3>
          <p class="text-gray-300">We run controlled A/B tests, validate results for statistical significance, and roll out only the winners.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Reporting & Iteration</h3>
          <p class="text-gray-300">We report on conversion lift, revenue impact, and ongoing opportunities, then repeat the cycle for continuous improvement.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="space-y-4">
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 1 ? null : 1" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>How do you find where we are losing conversions?</span>
        ...
        <div x-show="openFaq === 1" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          We review analytics, user behavior, and the funnel itself to identify where visitors are dropping off, then prioritize fixes based on impact.
        </div>
      </div>
      ...
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 2 ? null : 2" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>Do you run A/B tests before making permanent changes?</span>
        ...
        <div x-show="openFaq === 2" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Yes. Where it makes sense, we test changes against the current version before rolling them out fully.
        </div>
      </div>
    </div>
  </div>
