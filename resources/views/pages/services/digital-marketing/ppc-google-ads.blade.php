    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
      ...
      <div class="lg:col-span-7 flex flex-col justify-center">
        <nav class="flex items-center gap-2 text-sm font-medium text-purple-400 mb-6" aria-label="Breadcrumb">
          ...
          <span class="text-gray-500">/</span>
          <span class="text-purple-400">PPC / Google Ads</span>
        </nav>
        ...
        <div>
          ...
          <ul class="space-y-3 text-gray-300">
            <li class="flex items-start gap-3">
              ...
              <span>Ad spend is going up without a clear increase in leads or sales.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-purple-400 mt-1">◦</span>
              <span>Campaigns are targeting the wrong keywords or audience.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="text-purple-400 mt-1">◦</span>
              <span>There is no clear tracking in place to know what is actually working.</span>
            </li>
          </ul>
        </div>
      </div>
...
<section class="py-20 bg-[#0b0c10] border-t border-white/5">
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="mb-12">
      ...
      <p class="text-gray-400 text-lg">Paid search programs engineered for measurable ROI and efficient spend.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Google Ads Strategy & Setup</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">Account structure built for control and scale</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Account and campaign architecture</li>
            <li>• Keyword research and intent mapping</li>
            <li>• Conversion tracking and CRO alignment</li>
          </ul>
        </div>
      </div>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Paid Search Management</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">Ongoing optimization for performance</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Bid strategy and budget optimization</li>
            <li>• Ad copy and extension testing</li>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Landing Page Alignment</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">Traffic lands on pages built to convert</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Message match with ad copy</li>
            <li>• Clear CTAs and reduced friction</li>
            <li>• Speed and mobile optimization</li>
          </ul>
        </div>
      </div>
      ...
      <div class="group p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 hover:bg-white/[0.06] shadow-[0_0_20px_rgba(168,85,247,0.05)] transition-all duration-300 flex flex-col justify-between min-h-[220px]">
        <div>
          <h3 class="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors">Analytics & ROAS Optimization</h3>
          <p class="text-purple-400 text-sm font-medium mb-3">Track what matters and improve it</p>
          <ul class="text-gray-400 leading-relaxed space-y-1.5 text-sm">
            <li>• Google Ads and GA4 integration</li>
            <li>• ROAS, CPA, and conversion tracking</li>
            <li>• Clear reporting on spend and results</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Fully managed Google Ads campaigns</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Keyword targeting built around buyer intent</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Landing pages aligned with each campaign</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Clear reporting on cost, leads, and return</span></li>
        </ul>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10">
        ...
        <ul class="space-y-3 text-gray-300">
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Google Ads campaign management</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Keyword and search intent research</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Conversion tracking setup</span></li>
          <li class="flex items-start gap-3"><span class="text-purple-400 mt-1">◦</span><span>Bid strategy and budget optimization</span></li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12">
    <div class="max-w-3xl mb-16">
      ...
      <p class="text-gray-400 text-lg leading-relaxed">
        A structured approach to paid search that turns ad spend into measurable leads and revenue.
      </p>
    </div>
    ...
    <div class="space-y-6">
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          ...
          <p class="text-gray-300">We review your current Google Ads account, landing pages, and goals to define a strategy focused on profitable conversions.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Campaign Build & Tracking</h3>
          <p class="text-gray-300">We build campaign structures, write ad copy, and set up conversion tracking so every click can be tied to outcomes.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Landing Page Alignment</h3>
          <p class="text-gray-300">We align ad messaging with landing page content and CTAs so traffic converts instead of bouncing.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          <h3 class="text-2xl font-bold text-white mb-2">Bid Management & Optimization</h3>
          <p class="text-gray-300">We adjust bids, budgets, and targeting based on performance data to improve ROAS and reduce wasted spend.</p>
        </div>
      </div>
      ...
      <div class="p-8 bg-white/[0.03] border border-white/10 hover:border-purple-500/40 transition-all duration-300 flex flex-col md:flex-row gap-6 md:items-start">
        ...
        <div>
          ...
          <p class="text-gray-300">We report on leads, cost, and return, then scale winning campaigns while pausing underperforming spend.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="space-y-4">
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 1 ? null : 1" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>Do you manage the ad budget directly?</span>
        ...
        <div x-show="openFaq === 1" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          Yes. We manage campaigns end to end, including budget allocation, keyword targeting, and ongoing optimization.
        </div>
      </div>
      ...
      <div class="bg-white/[0.03] border border-white/10 overflow-hidden">
        <button @click="openFaq = openFaq === 2 ? null : 2" class="w-full text-left p-6 font-semibold text-white text-lg flex justify-between items-center focus:outline-none">
          <span>How is success measured?</span>
        ...
        <div x-show="openFaq === 2" x-collapse class="px-6 pb-6 text-gray-300 leading-relaxed">
          We track results against clear goals, such as leads, sales, or cost per acquisition, agreed with you before the campaign starts.
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-6 sm:px-12 text-center">
    <div class="bg-white/[0.03] border border-purple-500/40 p-10 md:p-16 shadow-[0_0_40px_rgba(168,85,247,0.2)] hover:shadow-[0_0_60px_rgba(168,85,247,0.35)] transition-all duration-300">
      <h2 class="text-3xl md:text-5xl font-extrabold text-white mb-6">
        Ready for paid search that actually converts?
      </h2>
